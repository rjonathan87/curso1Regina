...
const ALL_CHECKLIST_IDS = [
  ...
  // Unidad 3 · Python
  'u3-1-1','u3-1-2','u3-1-3','u3-1-4',
  'u3-2-1','u3-2-2','u3-2-3','u3-2-4',
  'u3-3-1','u3-3-2','u3-3-3','u3-3-4',
  'u3-4-1','u3-4-2','u3-4-3','u3-4-4',
  // Unidad 4 · Scratch
  'u4-1-1','u4-1-2','u4-1-3','u4-1-4',
  'u4-2-1','u4-2-2','u4-2-3','u4-2-4',
  'u4-3-1','u4-3-2','u4-3-3','u4-3-4',
  'u4-4-1','u4-4-2','u4-4-3','u4-4-4',
  // Debugging
  'dbg-1-1','dbg-1-2','dbg-1-3','dbg-1-4',
  // Proyecto Final
  'proy-1-1',
  'proy-2-1','proy-2-2',
  'proy-3-1','proy-3-2',
